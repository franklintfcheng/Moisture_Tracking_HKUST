...
function struct2nc(x,ncfilename,ncfiletype,deflate_lev)
    ...
    % See also https://stackoverflow.com/questions/21053406/matlab-save-cell-arrays-to-netcdf-file
    ...
    %/ Always delete any existing nc file first for rewriting
    delete(ncfilename);
    ...
    for i=1:length(vnames)
        ncwrite(ncfilename,vnames{i},x.(vnames{i}));
    end
end